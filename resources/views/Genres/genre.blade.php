                        ...
                        <div class="flex flex-col gap-10">
                            ...
                            <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                                ...
                                <div class="grid grid-cols-6 border-t border-stroke px-4 py-4.5 dark:border-strokedark sm:grid-cols-8 md:px-6 2xl:px-7.5">
                                    ...
                                    <div class="col-span-4 flex items-center m-2">
                                        <p class="text-sm font-medium text-black dark:text-white">
                                            Itadori Yuji, an ordinary high school boy, swallows a cursed object – a finger of Sukuna, a powerful demon. Now, empowered by the demon, Yuji joins a group of Jujutsu Sorcerers to combat other cursed spirits and the complete resurrection of Sukuna.
                                        </p>
                                    </div>
                                    <div class="col-span-1 flex items-center">
                                        <div class="flex items-center space-x-1">
